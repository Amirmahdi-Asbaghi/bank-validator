...
class BankRecordAdmin(admin.ModelAdmin):
    ...
    list_display = ("run_id", "timestamp", "source_type", "file_name",
                    "bank_code", "period", "account_code", "debit", "credit", "balance",
                    "valid", "errors")

    list_filter = ("valid", "errors")
    search_fields = ("run_id", "timestamp", "source_type", "file_name",
                    "bank_code", "period", "account_code", "debit", "credit", "balance",
                    "valid", "errors")
    readonly_fields = ("run_id", "timestamp", "source_type", "file_name",)
